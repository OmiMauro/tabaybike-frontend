    ...
    <section className='contact-section bg-black'>
      <div className='container'>
          ...
          <div className='col-md-4 mb-3 mb-md-0'>
            <div className='card py-4 h-100'>
              <div className='card-body text-center'><i className='fas fa-mobile-alt text-primary mb-2' />
                ...
                <hr className='my-4' />
                <div className='small text-black-50'> <a href='https://chat.whatsapp.com/GbJnz0pQ7hN4gskTBPQNkf' rel='noreferrer'>Unirte</a></div>
              </div>
            </div>
          </div>
        </div>
        <div className='social d-flex justify-content-center'>
          ...
          <a class='mx-2' href='https://chat.whatsapp.com/GbJnz0pQ7hN4gskTBPQNkf' target='_blank' rel='noreferrer'>
