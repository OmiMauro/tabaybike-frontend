    ...
    <section className='projects-section bg-light' id='projects'>
      <div className='container'>
        <div className='row align-items-center no-gutters mb-4 mb-lg-5'>
          <div className='col-xl-8 col-lg-7'><img className='img-fluid mb-3 mb-lg-0' src='imgs/portada1.jpg' alt='Telefonos de contacto' /></div>
        ...
        <div className='row justify-content-center no-gutters mb-5 mb-lg-0'>
          <div className='col-lg-6'><img className='img-fluid' src='imgs/contacts.jpg' alt='' /></div>
          <div className='col-lg-6'>
            <div className='bg-black text-center h-100 project'>
              <div className='d-flex h-100'>
                <div className='project-text w-100 my-auto text-center text-lg-left'>
                  <ul>
                    <li className='list-unstyled'>Complejos Saltos del Tabay: <a href='tel:+543743'>+543743400421</a></li>
                    <li className='list-unstyled'>Complejo Baden Baden:<a href='tel:+543743'>+543743460923</a></li>
                    <li className='list-unstyled'>Saltos del Tabay: <a href='tel:+543743'>+543743400421</a></li>
                    <li className='list-unstyled'>altos del Tabay: <a href='tel:+543743'>+543743400421</a></li>
                    <li className='list-unstyled'>Saltos del Tabay: <a href='tel:+543743'>+543743400421</a></li>
                  </ul>
